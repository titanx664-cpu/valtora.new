...
export function LandingHeader() {
  ...
  return (
    <header className={`sticky top-0 z-40 border-b backdrop-blur-xl transition-[background-color,border-color,box-shadow] duration-300 ${hasScrolled ? "border-primary/20 bg-background/88 shadow-[0_12px_36px_oklch(0.03_0.005_155_/_0.38)]" : "border-border/60 bg-background/80"}`}>
