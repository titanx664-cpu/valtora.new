...
4. In Supabase SQL Editor, run `supabase/migrations/0001_valtora.sql`.
...
- The ledger is the balance source of truth; client-side balances are never authoritative.
